...
%MONOPOLAR REVIEW (alternative)
%conditions = {"L_E2", "RE10", "L_E1", "R_E9"};

%MONOPOLAR REVIEW (alternative)
%conditions = {"R_E8", "RE10"};
conditions = {"R_E9","RE10","L_E0","L_E2","L_E1","L_E3"};
...
filename = 'DBS801_C4_PING_8Cs_2_HPmff';
filename2 = 'DBS801_C4_PING_8Cs_2_HPmff_b';
%Selected_Chan_sin = NetstationFile.(filename)(chan_spec,:); %whos NetstationFile
Selected_Chan_sin = [NetstationFile.(filename)(chan_spec,:),  NetstationFile.(filename2)(chan_spec,:)]; %whos NetstationFile; %whos NetstationFile
